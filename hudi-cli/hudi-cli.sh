...
java -cp /usr/share/aws/emr/emrfs/conf:/usr/share/aws/emr/emrfs/lib/*:/usr/share/aws/emr/emrfs/auxlib/*:/usr/lib/hadoop/*:/usr/lib/spark/jars/*:${HADOOP_CONF_DIR}:${SPARK_CONF_DIR}:$DIR/../lib/*:$HOODIE_JAR:${OTHER_JARS}:${CLIENT_JAR} -DSPARK_CONF_DIR=${SPARK_CONF_DIR} -DHADOOP_CONF_DIR=${HADOOP_CONF_DIR} org.springframework.shell.Bootstrap $@